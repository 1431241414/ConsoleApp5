...
namespace RoguelikeGame
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Weapon playerWeapon = new Weapon("Тоцуко", 20, 10);
        ...
        {
            string[] enemyNames = { "Варвар", "Гоблин", "Мутант", "Петя", "Циклоп" };
            string[] weaponNames = { "Экскалибур", "Боевой топор", "Кинжал", "Меч берсерка" };
